...
export const ID_TOPICS: Record<string, string> = {
  ...
  "autocon-btn": "implicit-constraints",
  "grid-btn": "grid",
  "snap-btn": "object-snap",
  "osnap-btn": "object-snap",
  "grid-size-btn": "grid",
  "grid-size-menu": "grid",
  "grid-color": "grid",
  "grid-style-btn": "grid",
  "grid-style-menu": "grid",
...
/** Toolbar section / group ids → topics (for controls inside them that carry no id). */
export const GROUP_TOPICS: Record<string, string> = {
  ...
  "sec-role": "roles",
  "sec-shapes": "tools",
  "sec-color": "body-colour",
  "sec-pattern": "tools",
  "sec-boolean": "combine",
  "sec-mating": "tools",
  "sec-actuator": "tool-linearActuator",
  "sec-transform": "editing",
  "sec-component": "components",
  "sec-constraints": "constraints",
  "sec-grid": "grid",
  "sec-measure": "dimensions",
  "sec-snap": "object-snap",
  "sec-view": "view",
